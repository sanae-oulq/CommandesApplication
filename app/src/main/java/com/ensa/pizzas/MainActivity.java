...
import com.ensa.pizzas.adapter.ProduitAdapter;
import com.ensa.pizzas.classes.Produit;
import com.ensa.pizzas.services.ProduitService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("photo", ps.findById(Integer.parseInt(idd.getText().toString())).getPhoto());
                intent.putExtra("nom", ps.findById(Integer.parseInt(idd.getText().toString())).getNom());
                intent.putExtra("description", ps.findById(Integer.parseInt(idd.getText().toString())).getDescription());
                intent.putExtra("ingredients", ps.findById(Integer.parseInt(idd.getText().toString())).getDetailsingred());
                intent.putExtra("preparation", ps.findById(Integer.parseInt(idd.getText().toString())).getPreparation());

                startActivity(intent);
                //intent.putExtra("image",genre);
                ...
                alertDialogBuilder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        list.setAdapter(new ProduitAdapter(ps.findAll(), MainActivity.this));
